...
class Create_Geniki_Taxydromiki_Vouchers_For_Woo_V3_Public {
	...
	function gt_extra_shipping_rate_description( $method ) {
  	    ...
  	    echo '<p>Από 17/6 έως 15/10/2024, η Γενική Ταχυδρομική εφαρμόζει για τις παραδόσεις σε Ζάκυνθο, Κέρκυρα, Λευκάδα, Μύκονο, Ρόδο, Σαντορίνη πρόσθετο τέλος διακίνησης €6,20 ανά πακέτο. Για να μην χρεωθείτε το πρόσθετο τέλος, σας προτείνουμε να επιλέξετε "παραλαβή από Γενική Ταχυδρομική" και να μεταβείτε να παραλάβετε από το τοπικό σημείο εξυπηρέτησης της Γενικής Ταχυδρομικής.</p>';
  		 }
	}
}
